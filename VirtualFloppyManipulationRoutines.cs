        ...
        */
        ...
        private void ProcessOS9ImageFile(string filename, string path, XmlDocument doc, XmlNode currentNode)
        {
            ...
            try
            {
                ...
                PhysicalParameters physicalParameters = PhysicalGeometry(fs);
        ...
        private PhysicalParameters PhysicalGeometry (FileStream fs)
        {
            // save current position

            long currentPosition = fs.Position;

            PhysicalParameters physicalParameters = new PhysicalParameters();
            ...
            physicalParameters.numberOfTracks = (physicalParameters.numberOfTracks + 1) / 2;
            ...
            physicalParameters.sectorsOnTrackZeroSideOne = (physicalParameters.numberOfTracks - 1) * physicalParameters.sectorsPerTrack;
            if ((physicalParameters.formatByte & 0x0001) != 0)   // double sided
            {
                physicalParameters.sectorsOnTrackZeroSideOne *= 2;
            }
            physicalParameters.sectorsOnTrackZeroSideOne = physicalParameters.sectorsOnTrackZeroSideOne + physicalParameters.sectorsOnTrackZeroSideZero;
            physicalParameters.sectorsOnTrackZeroSideOne = nTotalSectors - physicalParameters.sectorsOnTrackZeroSideOne;
